...
func FetchKomikDetails(c *fiber.Ctx) error {
	...
	collector.OnHTML("#content > .wrapper", func(e *colly.HTMLElement) {
		...
		e.ForEach(
			".chapter_ > #chapter_body > .main-reading-area > img",
